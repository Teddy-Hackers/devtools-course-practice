...
template <typename TData>
bool AVLTree<TData>::containRecurse(AVLNode<TData>* node, const TData& value) const {
...
template <typename TData>
void AVLTree<TData>::insertRecurse(const TData& value, AVLNode<TData>* (&currNode)) {
...
template <typename TData>
void AVLTree<TData>::removeRecurse(const TData& value, AVLNode<TData>* (&current)) {
...
template <typename TData>
void AVLTree<TData>::printRecurse(AVLNode<TData>* node, int count, std::ostream& os) const {
