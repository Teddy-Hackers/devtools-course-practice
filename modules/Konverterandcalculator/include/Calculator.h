...
#ifndef MODULES_KONVERTERANDCALCULATOR_INCLUDE_CALCULATOR_H_
#define MODULES_KONVERTERANDCALCULATOR_INCLUDE_CALCULATOR_H_
#include <iostream>
#include <string>
...
#endif  // MODULES_KONVERTERANDCALCULATOR_INCLUDE_CALCULATOR_H_
