...
double NumIntegral::integral1D(double a, double b, int n, const std::function<double(double)>& fun) {
	if (n < 1) {
...
double NumIntegral::integral3D(double a, double b, double c, double d, double e,
