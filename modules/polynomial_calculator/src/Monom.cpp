...
bool Monom::operator != (const Monom& _monom) const {
    return (coefficient != _monom.coefficient || degreeX != _monom.degreeX ||
        degreeY != _monom.degreeY || degreeZ != _monom.degreeZ);
}
...
bool Monom::degreeEq(const Monom& _monom) {
    return (degreeX == _monom.degreeX && degreeY == _monom.degreeY &&
        degreeZ == _monom.degreeZ);
}

Monom Monom::operator + (const Monom& _monom) const {
    if (this->degreeX == _monom.degreeX && this->degreeY == _monom.degreeY &&
        this->degreeZ == _monom.degreeZ) {
